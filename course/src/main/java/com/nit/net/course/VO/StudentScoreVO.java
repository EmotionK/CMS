...
public class StudentScoreVO implements Serializable {
	...
	private static final long serialVersionUID = 1679955793360998533L;
	...
	public String toString() {
		return "StudentScoreVO [id=" + id + ", username=" + username + ", password=" + password + ", name=" + name
				+ ", gender=" + gender + ", college=" + college + ", squad=" + squad + ", studentScores="
				+ studentScores + "]";
	}
